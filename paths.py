...
# All code files live in APP_DIR  (~/Downloads/Timetable-Gen/)
# All user data lives in USER_DIR (~/Downloads/Timetable-Gen/user-dat/)
...
APP_DIR  = os.path.join(os.path.expanduser("~"), "Downloads", "Timetable-Gen")
